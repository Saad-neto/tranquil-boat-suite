...
const BookingSection = () => {
  return (
    <section id="reservas" className="py-20 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 animate-fade-up">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Preencha o formulário abaixo e garanta seu lugar nos melhores passeios de João Pessoa
          </p>
        </div>
